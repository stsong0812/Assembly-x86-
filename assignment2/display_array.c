...
//   Language: C
//   Compile: g++ -c -Wall -no-pie -m64 -std=c++17 -o display_array.o display_array.c
//   Link: g++ -m64 -no-pie -o addFloatArray.out manager.o input_array.o main.o magnitude.o append.o display_array.o -std=c++17
//   Purpose: Provides the function call for Display to display the floating point values from user input
//========================================================================================================
